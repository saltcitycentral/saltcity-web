...
export default function HeroStage() {
  ...
  const SLIDES: Slide[] = useMemo(
    () => [
      ...
      },
      {
        ...
        subline: "Grow in the Word, build conviction, and live with JESUS as your example.",
        primaryCta: {
          label: "Watch Sermons",
  ...
  // progress bar (cheap, CSS animation keyed by active index)
  ...
  return (
    <section className="relative overflow-hidden">
      {/* Stage height tuning */}
      <div className="relative h-[78vh] min-h-[560px] w-full lg:h-[92vh] lg:min-h-[680px]">
        {/* Slides */}
        {SLIDES.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              {/* subtle texture sweep (very light) */}
